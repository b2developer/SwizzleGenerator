...
std::string DLL_MACRO = "MATHSLIBRARY_API"; //if you have DLLs implemented
std::string VECTOR_HEAD = "Vector"; //what your vectors are called before the number eg. |Vector|3 or |Vec|4 or |v|2
std::string VECTOR_END = "T"; //any abitirary vector name after the number (before the template) eg. Vector3|T| or vec2|coord|

//template specifications
bool includeTemplate = true; //set this to false if you don't have templates
std::string VECTOR_T_ADD = "<T>"; //template typename with brackers eg. Vector3T|<T>| or vec4T|<real>| or v2coord|<vecType>|, NOTE: """""set to nothing if there are no templates""""
std::string TEMPLATE_MACRO = "TEMPLATE"; //if you have templates implemented
